...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionUpload_file_s = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/action_icons/Database-Cloud-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUpload_file_s.setIcon(icon4)
        self.actionUpload_file_s.setObjectName("actionUpload_file_s")
        self.menu_File.addAction(self.actionLoad_Files)
        self.menu_File.addAction(self.actionUpload_file_s)
        ...
        self.toolBar.addAction(self.actionUpload_file_s)
        self.toolBar.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionUpload_file_s.setText(_translate("MainWindow", "Upload file(s)"))
